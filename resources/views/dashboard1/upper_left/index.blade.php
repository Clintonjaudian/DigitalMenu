        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Upper Left</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="card card-info">
                ...
                <div class="float-right">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addUpperLeftProductModalBtn">Add Product</button>
                </div>

                <table id="upperLeftDatatable" class="table table-bordered table-striped" width="100%">
                    <thead>
                    <tr>
                    <th>Product Name</th>
                    <th>Price</th>
                    <th>Food Image</th>
                    <th>Upper Left Price Tag</th>
...
<div class="modal" tabindex="-1" role="dialog" id="addUpperLeftProductModalBtn">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <div class="card-body">
                <form method="POST" id="addUpperLeftForm" enctype="multipart/form-data"> 
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="original_price" class="control-label">Select Upper Left Price Tag</label>
                  ...
                  <div class="form-group float-right">
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" id="addUpperLeftCancelBtn">Cancel</button>
...
<div class="modal" tabindex="-1" role="dialog" id="editUpperLeftProductModalBtn">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <div class="card-body">
                <form method="POST" id="editUpperLeftForm" enctype="multipart/form-data"> 
                  @csrf
                  @method('PUT')
                  <div class="row">
                    <div class="form-group col-6">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="edit_original_price" class="control-label">Edit Upper Left Price Tag</label>
                      <br>
                  ...
                  <div class="form-group float-right">
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" id="editUpperLeftCancelBtn">Cancel</button>
...
@push('js')
    ...
    <script>
        ...
        {
            // Yajra DataTable
            $("#upperLeftDatatable").DataTable(
            {
                processing:true,
                serverSide:true,
                ajax:{
                    url:"{{route('upper_left_menu1.index')}}"
                },
                columns:[
                    {
                    data:'product_name',
            ...
            // Parsley Validator
            $("#addUpperLeftForm").parsley();

            // Cancel Btn when adding product
            $("#addUpperLeftCancelBtn").on('click', function()
            {
            $("#addUpperLeftForm").parsley().reset();
            $("#addUpperLeftForm")[0].reset();
            });

            // Add Product
            $("#addUpperLeftForm").on('submit', function(event)
            {
                ...
                $.ajax(
                {
                    url:"{{route('upper_left_menu1.store')}}",
                    method:'post',
                    data:formData,
                    dataType:'json',
                    cache:false,
                    ...
                    else
                    {
                        if(data.success)
                        {
                        $("#addUpperLeftProductModalBtn").modal('hide');
                        $("#addUpperLeftForm")[0].reset();
                        $('#addUpperLeftForm').parsley().reset();
                        $("#upperLeftDatatable").DataTable().ajax.reload();
            ...
            $(document).on('click', '.edit', function()
            {
                ...
                $.ajax(
                {
                    ...
                    success:function(data)
                    {
                        ...
                        $("#editUpperLeftProductModalBtn").modal('show');

                        // Submation of edited data
                        $("#editUpperLeftForm").unbind('submit').bind('submit', function(event)
                        {
                            event.preventDefault();
                            var formData = new FormData($(this)[0]);
                            ...
                            $.ajax(
                            {
                                ...
                                success:function(data)
                                {
                                    if(data.success)
                                    {
                                        $("#editUpperLeftProductModalBtn").modal('hide');
                                        $("#editUpperLeftForm")[0].reset();
                                        $("#editUpperLeftForm").parsley().reset();
                                        $("#upperLeftDatatable").DataTable().ajax.reload();
