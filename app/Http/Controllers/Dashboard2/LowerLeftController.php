...
class LowerLeftController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard2.lower.left');
    }
    ...
    public function store(Request $request)
    {
        ...
        $product = LowerLeft::where('product_name', $product_name)->first();
