...
class UpperLeftController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) 
        {
            $data = UpperLeftMenu1::where('status', '!=', 2);
        ...
        return view('dashboard1.upper_left.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $product = UpperLeftMenu1::where('product_name', $product_name)->first();
    ...
    {
        $destroy = UpperLeftMenu1::destroy($id);
