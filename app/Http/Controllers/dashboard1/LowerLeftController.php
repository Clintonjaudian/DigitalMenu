...
class LowerLeftController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) 
        {
            $data = LowerLeftMenu1::where('status', '!=', 2);
        ...
        return view('dashboard1.lower_left.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $product = LowerLeftMenu1::where('product_name', $product_name)->first();
    ...
    {
        $destroy = LowerLeftMenu1::destroy($id);
